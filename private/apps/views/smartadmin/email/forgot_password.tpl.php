					...
					<table style="width: 500px; height: 100%;border: 1px solid #ccc; background: #fff;" id="table-content">
						...
						<tr>
							<td align="left" style="vertical-align: top;padding: 30px;">
								...
								<p>&nbsp;</p>
								<p>Klik op onderstaande link om jouw wachtwoord opnieuw in te stellen of jouw account te ontgrendelen</p>
								<!-- <p><?=anchor(links_url(array('class'=>'auth','method'=>'reset_password')).'/'. $forgottenPasswordCode, links_url(array('class'=>'auth','method'=>'reset_password')).'/'. $forgottenPasswordCode)?></p> -->
								<p><?=anchor(links_url(array('class'=>'auth','method'=>'reset_password')).'/'. $forgottenPasswordCode, 'LINK')?></p>
								<p>&nbsp;</p>
								<p>Wanneer je nog steeds problemen ervaart met jouw account, neem dan contact op met de beheerder.</p>
								<p>&nbsp;</p>
								<p>&nbsp;</p>
