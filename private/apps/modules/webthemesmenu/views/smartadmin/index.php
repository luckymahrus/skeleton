...
<div class="row">
	...
	<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
		...
		<?php else : ?>
		<a href="<?=links_url(array('class'=>$this->router->class,'method'=>'add'))?>" data-toggle="modal" data-target="#modal-<?=$this->router->class?>" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-plus fa-lg"></i>&emsp;<?=$this->lang->line('label_btn_add_themesmenu')?></a>
		<?php endif; ?>
	</div>
	<?php endif; ?>
</div>
						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
							<thead>			                
								<tr>
									...
									<th data-class="expand">Themes Name</th>
									<th data-hide="phone">Themes Title</th>
									<th data-hide="phone,tablet">Themes Menu Name</th>
									<th data-hide="phone,tablet">Themes Menu Title</th>
