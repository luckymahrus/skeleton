						...
						<table id="dt_<?=$this->router->class?>" class="table table-striped table-bordered table-hover" width="100%">
							<thead>			                
								<tr>
									...
									<th data-class="expand"><i class="fa fa-fw fa-group text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_groups_name')?></th>
									<th data-hide="phone"><i class="fa fa-fw fa-comments text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_groups_description')?></th>
									<th data-hide="phone,tablet"><i class="fa fa-fw fa-bar-chart-o text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_groups_level')?></th>
									<th data-hide="phone,tablet"><i class="fa fa-fw fa-ban text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_groups_internal')?></th>
