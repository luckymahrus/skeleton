...
<div class="row">
	...
	<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
		...
		<a href="<?=links_url(array('class'=>$this->router->class,'method'=>'add'))?>" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-plus fa-lg"></i>&emsp;<?=$this->lang->line('label_btn_add_group')?></a>
		<?php else : ?>
		<a href="<?=links_url(array('class'=>$this->router->class,'method'=>'add'))?>" data-toggle="modal" data-target="#modal-<?=$this->router->class?>" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-plus fa-lg"></i>&emsp;<?=$this->lang->line('label_btn_add_group')?></a>
		<?php endif; ?>
	</div>
	<?php endif; ?>
</div>
						...
						<table id="dt_<?=$this->router->class?>" class="table table-striped table-bordered table-hover" width="100%">
							<thead>			                
								<tr>
									...
									<th data-class="expand"><i class="fa fa-fw fa-group text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_webroutes_name')?></th>
									<th data-class="expand"><i class="fa fa-fw fa-group text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_webroutes_title')?></th>
									<th data-hide="phone"><i class="fa fa-fw fa-comments text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_webroutes_params')?></th>
									<th data-hide="phone,tablet"><i class="fa fa-fw fa-bar-chart-o text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_webroutes_value')?></th>
									<th data-hide="phone,tablet"><i class="fa fa-fw fa-ban text-muted hidden-md hidden-sm hidden-xs"></i> <?=$this->lang->line('table_column_webmodules_name')?></th>
