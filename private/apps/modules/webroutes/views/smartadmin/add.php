							...
							<fieldset>
								<section>
									...
									<label class="input<?=(!empty(form_error('groups_name'))) ? ' state-error' : ''?>">
										...
										<?=(!empty(form_error('groups_name'))) ? '<i class="form-control-feedback glyphicon pull-right"></i>' : ''?>
									</label>
								...
								<section>
									...
									<label class="input<?=(!empty(form_error('groups_description'))) ? ' state-error' : ''?>">
										...
										<?=(!empty(form_error('groups_description'))) ? '<i class="form-control-feedback glyphicon pull-right"></i>' : ''?>
									</label>
								...
								<section>
									...
									<label class="input<?=(!empty(form_error('groups_level'))) ? ' state-error' : ''?>">
										...
										<?=(!empty(form_error('groups_level'))) ? '<i class="form-control-feedback glyphicon pull-right"></i>' : ''?>
									</label>
