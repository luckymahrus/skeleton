 ...
 * file			: private/apps/modules/webroutes/controllers/Webroutes.php
...
class Webroutes extends APP_Controller
{
	protected $models = array('webroutes');
	...
	public function get()
	{
		...
		{
			$response 	= $this->webroutes->datatables();
		}
		else
		{
			$response 	= $this->webroutes->get_all();
		}
...
/* End of file Webroutes.php */
/* Location: private/apps/modules/webroutes/controllers/Webroutes.php */
