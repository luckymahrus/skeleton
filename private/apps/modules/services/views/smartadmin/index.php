...
<div class="row">
	...
	<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
		...
		<a href="<?=links_url(array('class'=>$this->router->class,'method'=>'add'))?>" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-plus fa-lg"></i>&emsp;<?=$this->lang->line('label_btn_add_services')?></a>
		<?php else : ?>
		<a href="<?=links_url(array('class'=>$this->router->class,'method'=>'add'))?>" data-toggle="modal" data-target="#modal-<?=$this->router->class?>" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-plus fa-lg"></i>&emsp;<?=$this->lang->line('label_btn_add_services')?></a>
		<?php endif; ?>
	</div>
	<?php endif; ?>
</div>
