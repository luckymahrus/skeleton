			...
			<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<section>
					...
					<label class="input<?=(!empty(form_error('code'))) ? ' state-error' : ''?>">
						<?=form_input($code,$code['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'50','title'=>$code['title'],'placeholder'=>$code['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('name'))) ? ' state-error' : ''?>">
						<?=form_input($name,$name['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'50','title'=>$name['title'],'placeholder'=>$name['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('category'))) ? ' state-error' : ''?>">
						<?=form_input($category,$category['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','title'=>$category['title'],'placeholder'=>$category['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('note'))) ? ' state-error' : ''?>">
						<?=form_input($note,$note['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','rows'=>'26','title'=>$note['title'],'placeholder'=>$note['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('website'))) ? ' state-error' : ''?>">
						<?=form_input($website,$website['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','title'=>$website['title'],'placeholder'=>$website['placeholder']))?>
					</label>
			...
			<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<section>
					...
					<label class="input<?=(!empty(form_error('address'))) ? ' state-error' : ''?>">
						<?=form_input($address,$address['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'50','title'=>$address['title'],'placeholder'=>$address['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('city'))) ? ' state-error' : ''?>">
						<?=form_input($city,$city['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'50','title'=>$city['title'],'placeholder'=>$city['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('province'))) ? ' state-error' : ''?>">
						<?=form_input($province,$province['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','title'=>$province['title'],'placeholder'=>$province['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('country'))) ? ' state-error' : ''?>">
						<?=form_input($country,$country['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','title'=>$country['title'],'placeholder'=>$country['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('post_code'))) ? ' state-error' : ''?>">
						<?=form_input($post_code,$post_code['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','title'=>$post_code['title'],'placeholder'=>$post_code['placeholder']))?>
					</label>
				...
				<section>
					...
					<label class="input<?=(!empty(form_error('phone'))) ? ' state-error' : ''?>">
						<?=form_input($phone,$phone['value'],array('class'=>'input-lg','disabled'=>'disabled','maxlength'=>'100','title'=>$phone['title'],'placeholder'=>$phone['placeholder']))?>
					</label>
