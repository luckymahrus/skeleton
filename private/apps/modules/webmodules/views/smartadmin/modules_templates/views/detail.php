...
';
echo '										<label class="label strong"><?=$'.$field->name.'[\'label\']?></label>
';
echo '										<label class="input select state-disabled">
';
echo '											<?=form_dropdown($'.$field->name.'[\'name\'],$'.$field->name.'[\'data\'], @$'.$field->name.'[\'selected\'], array(\'class\'=>\'\',\'disabled\'=>\'disabled\'))?>
';
echo '										</label>
';
echo '									</section>
...
echo '										<label class="label strong"><?=$'.$field->name.'[\'label\']?></label>
';
echo '										<label class="input state-disabled">
';
echo '											<?=form_input($'.$field->name.',@$'.$field->name.'[\'value\'],array(\'class\'=>\'\',\'disabled\'=>\'disabled\',\'maxlength\'=>\''.$field->max_length.'\',\'title\'=>$'.$field->name.'[\'title\'],\'placeholder\'=>$'.$field->name.'[\'placeholder\']))?>
';
...
'; ?>
								<button type="button" class="btn btn-default" onclick="window.history.back();">
									<?php echo '<?=$this->lang->line(\'label_btn_back\')?>
'; ?>
								</button>
<?php echo '<?php else : ?>
'; ?>
								<button name="cancel" type="button" class="btn btn-default" data-dismiss="modal">
									<?php echo '<?=$this->lang->line(\'label_btn_close\')?>
'; ?>
								</button>
<?php echo '<?php endif; ?>	
'; ?>
