...
<?php echo '<?php endif; ?>
'; ?>
						<?php echo '<?=form_open_multipart(links_url(array(\'class\'=>$this->router->class,\'method\'=>$this->router->method)),array(\'id\'=>$this->router->class,\'name\'=>$this->router->class,\'class\'=>\'smart-form\'))?>
'; ?>
							<fieldset>
...
?>
							...
							<footer>
								<button type="submit" class="btn btn-primary">
									<?php echo '<?=$this->lang->line(\'label_btn_submit\')?>
'; ?>
								</button>
<?php echo '<?php if(!$this->input->is_ajax_request()) : ?>
'; ?>
