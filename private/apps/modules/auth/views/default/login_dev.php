                        ...
                        <fieldset>
				            <div class="uk-grid">
							    <div class="uk-width-1-1">
									<h3 class="page-title"><?=lang('login_dev_heading')?></h3>
							    </div>
			                </div>
                            ...
                            <div class="uk-form-row"><button class="uk-button uk-width-1-1 uk-button-large uk-button-back" data-uk-tooltip="{pos:'top-left'}" title="<?=$this->lang->line('title_btn_login_admin')?>"><?=$this->lang->line('login_dev_submit_btn')?></button></div>
                        </fieldset>
                ...
                <div class="uk-width-1-1 uk-visible-small">
					<?=form_open(links_url(array('class'=>$this->router->class,'method'=>$this->router->method)), array('class' => 'uk-form', 'id' => 'login-form', 'method' => 'post'))?>
                        <fieldset>
                            ...
                            <div class="uk-form-row"><button class="uk-button uk-width-1-1 uk-button-large" data-uk-tooltip="{pos:'top-left'}" title="<?=$this->lang->line('title_btn_login_admin')?>"><?=$this->lang->line('label_btn_login_admin')?></button></div>
                        </fieldset>
