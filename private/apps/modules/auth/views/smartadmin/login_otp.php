						...
						<div class="well no-padding">
							<?=form_open(links_url(array('class'=>$this->router->class,'method'=>$this->router->method)), array('class' => 'smart-form client-form', 'id' => 'login-form', 'method' => 'post'))?>
								...
								<fieldset>
									...
									<section>
										<?=lang('login_identity_label', $identity['name'], array('class'=>'label'))?>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<?=form_input($identity)?>
											<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> <?=$this->lang->line('login_identity_label')?></b>
										</label>
                                    	<?=form_error($identity['name'],'<div class="note note-error">','</div>')?>
									</section>

									<section>
										<?=lang('login_password_label', $password['name'], array('class'=>'label'))?>
