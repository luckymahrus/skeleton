				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
						<div class="well no-padding">
							<?=form_open(links_url(array('class'=>$this->router->class,'method'=>$this->router->method)).'/'.$code, array('class' => 'smart-form client-form', 'id' => $this->router->class.'-'.$this->router->method, 'method' => 'post'),array('users_id'=>$users_id,'code'=>$code))?>
								<header>
									<?=lang('login_heading')?>
								</header>
								...
								<fieldset>
									...
									<section>
										<?=lang('login_password_label', $new_password['name'], array('class'=>'label'))?>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
		                                    <?=form_password($new_password,$new_password['value'],array('class'=>'','title'=>$new_password['title'],'placeholder'=>$new_password['placeholder']))?>
											<b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> <?=$this->lang->line('login_password_label')?></b>
										</label>
                                    	<?=form_error($new_password['name'],'<div class="note note-error">','</div>')?>
										<div class="note">
									...
									<section>
										<?=lang('login_password_label', $new_password_confirm['name'], array('class'=>'label'))?>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
		                                    <?=form_password($new_password_confirm,$new_password_confirm['value'],array('class'=>'','title'=>$new_password_confirm['title'],'placeholder'=>$new_password_confirm['placeholder']))?>
											<b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> <?=$this->lang->line('login_password_label')?></b>
										</label>
                                    	<?=form_error($new_password_confirm['name'],'<div class="note note-error">','</div>')?>
										<div class="note">
											<a href="<?=links_url(array('class'=>'auth','method'=>'forgot_password'))?>"><?=lang('login_forgot_password')?></a>
										</div>
									</section>
									...
									<section>
										<label class="checkbox">
											...
											<i></i><?=lang('login_remember_label', 'remember')?>
										</label>
									</section>
								</fieldset>
								<footer>
