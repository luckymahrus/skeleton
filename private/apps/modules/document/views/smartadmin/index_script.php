...
$allow_download = $this->custom_auth->is_allowed_to($this->router->class,'download');
?>
	...
	$(document).ready(function()
	{
		...
		dt_<?=$this->router->class?> = $('#dt_<?=$this->router->class?>').dataTable(
		{
			...
			[
			    ...
			    {
			        "data": 'uploads_description',
			        "searchable": true,
			        "orderable": true,
			        "targets": 2,
			    },
			    {
			        "data": 'uploads_orig_name',
			        "searchable": true,
			        "orderable": true,
			        "targets": 3,
			    },
			    {
			        "data": 'uploads_file_ext',
			        "searchable": true,
			        "orderable": false,
			        "targets": 4,
			    },
			    {
			        "data": 'uploads_file_size',
			        "searchable": false,
			        "orderable": true,
			        "targets": 5,
			        "className": "dt-body-center",
			    },
			    {
					...
					"render": function (data, type, full, meta)
		            {
						...
						switch(data)
						{
						    case '0'	: 	html = '<span class="label label-primary">Inactive</span>';		break;
						    case '1'	: 	html = '<span class="label label-success">Published</span>';	break;
						    ...
						    default 	: 	html = '<span class="label label-primary">Inactive</span>';		break;
						}
						return html;
		            }
			    },
				<?php if($allow_detail || $allow_edit || $allow_delete || $allow_download) : ?>
			    {
			        "searchable": false,
			        "orderable": false,
			        "targets": 7,
					...
					"render": function (data, type, full, meta)
		            {
		            	var html = '';
		            	<?php if($allow_detail) : ?>
		            	html += '<a href="javascript:void(0);" class="btn btn-xs btn-success action-detail" data-id="'+full.uploads_id+'" data-action="detail" rel="tooltip" data-placement="top" data-original-title="Detail"><i class="fa fa-eye"></i></a>&nbsp;';
		            	<?php endif; if($allow_download) : ?>
		            	html += '<a href="<?=links_url(array('class'=>$this->router->class,'method'=>'download'))?>/'+full.uploads_raw_name+'" class="btn btn-xs btn-warning" target="_blank" data-id="'+full.uploads_id+'" data-action="download" rel="tooltip" data-placement="top" data-original-title="Download"><i class="fa fa-download"></i></a>&nbsp;';
		            	<?php endif; if($allow_edit) : ?>
		            	html += '<a href="javascript:void(0);" class="btn btn-xs btn-primary action-edit" data-id="'+full.uploads_id+'" data-action="edit" rel="tooltip" data-placement="top" data-original-title="Edit"><i class="fa fa-pencil"></i></a>&nbsp;';
		            	<?php endif; if($allow_delete) : ?>
		            	html += '<a href="javascript:void(0);" class="btn btn-xs btn-danger action-delete" data-id="'+full.uploads_id+'" data-action="delete" rel="tooltip" data-placement="top" data-original-title="Delete"><i class="fa fa-trash"></i></a>';
		            	<?php endif; ?>
