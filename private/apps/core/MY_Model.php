...
class MY_Model extends CI_Model
{
    ...
    protected $_temporary_with_deleted = 0;
    protected $_temporary_only_deleted = 0;
    ...
    public function delete($id)
    {
        ...
        if ($this->soft_delete)
        {
            $result = $this->_database->update($this->_table, array( $this->soft_delete_key => 1 ));
        }
        else
        {
    ...
    function dropdown()
    {
        ...
        if ($this->soft_delete && $this->_temporary_with_deleted !== 1)
        {
            $this->_database->where($this->soft_delete_key, 0);
        }
